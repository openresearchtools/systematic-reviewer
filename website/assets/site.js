(function () {
  ...
  function citationOverlayHTML(idSuffix) {
    return [
      ...
      '    <h3>APA 7th</h3>',
      '    <p>Rutkauskas, L. (2026). <em>Systematic Reviewer</em> (Version <span data-citation-version>Research Preview</span>) [Computer software]. Open Research Tools. <a href="https://systematicreviewer.com" target="_blank" rel="noopener">https://systematicreviewer.com</a></p>',
      '    <h3>Chicago</h3>',
