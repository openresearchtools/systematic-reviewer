var SystematicReviewerSessionAgent = (() => {
	...
	function buildSystemPrompt(current, sessionID, packet = {}) {
		...
		sections.push(
			...
			"- Prefer real tool calls over speculative prose. If you need project state, read it. If a major workflow run just succeeded, inspect log.txt and patch the relevant REPORT.md sections with the workspace/report tools before you finish.",
